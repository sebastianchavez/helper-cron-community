...
exports.registerOllamaChatHandler = registerOllamaChatHandler;
const electron_1 = require("electron");
function registerOllamaChatHandler() {
    ...
    electron_1.ipcMain.handle('ollama:chat', async (_evt, payload) => {
        try {
    ...
    electron_1.ipcMain.on('ollama:chat:stream', async (event, payload) => {
        try {
            const res = await fetch('http://localhost:11434/api/chat', {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
    ...
    electron_1.ipcMain.handle('ollama:download-model', async (event, modelName) => {
        try {
    ...
    electron_1.ipcMain.handle('ollama:delete-model', async (_evt, modelName) => {
        try {
